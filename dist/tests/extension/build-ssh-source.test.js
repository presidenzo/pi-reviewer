...
describe("buildSSHSource", () => {
    ...
    it("returns 'current vs origin/main' by default (auto-detect both)", () => {
        ...
        const result = buildSSHSource({}, "/repo");
